...
function MusicToggle() {
  ...
  const oscRefs = reactExports.useRef([]);
  const startMusic = reactExports.useCallback(() => {
    ...
    for (let i = 0; i < frequencies.length; i++) {
      ...
      lfo.start();
      oscGain.gain.setValueAtTime(0.025 - i * 3e-3, ctx.currentTime);
      osc.connect(oscGain);
  ...
  const stopMusic = reactExports.useCallback(() => {
...
function PetalCanvas() {
  ...
  const petalsRef = reactExports.useRef([]);
  reactExports.useEffect(() => {
...
function ApologyPage({ onYes, onNo }) {
  const [escapeCount, setEscapeCount] = reactExports.useState(0);
  const [noOffset, setNoOffset] = reactExports.useState({ x: 0, y: 0 });
  const noContainerRef = reactExports.useRef(null);
  const canClickNo = escapeCount >= 5;
  const handleNoEscape = reactExports.useCallback(() => {
  ...
  const escapeTaunt = escapeCount === 1 ? "Heyyy, not so fast! 😤" : escapeCount === 2 ? "The button is running away from you 😂" : escapeCount === 3 ? "Even the button doesn't want to say no 💕" : escapeCount === 4 ? "One more try... 👀" : null;
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      className: "page-layer",
      style: {
        background: "radial-gradient(ellipse at 50% 40%, oklch(93% 0.03 5) 0%, oklch(97% 0.015 5) 80%)",
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "romantic-card slide-up-1", style: { width: "100%" }, children: [
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "p",
                      {
                        ...
                        children: "I know I messed up... and I hate that I made you upset 🥺💔"
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "p",
                      {
                        ...
                        children: "Talking to you is my favorite part of the day, and without you everything feels incomplete..."
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "p",
                      {
                        ...
                        children: "Even one minute feels too long, and you said 48 hours 😭"
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "p",
                      {
                        ...
                        children: "Please forgive me, my love 💗👉👈"
                      }
                    )
                  ]
                }
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  ...
                  children: "Could you please forgive me, my love? 💞"
                }
              )
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
                      ...
                      title: canClickNo ? "Fine, click it... 😤" : `Running away! (${escapeCount}/5 attempts)`,
                      children: canClickNo ? "NO 😤" : `NO 😤 (${5 - escapeCount} left)`
                    }
                  )
                ]
              }
            ),
            !canClickNo && escapeCount > 0 && escapeTaunt && /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                style: {
                  fontFamily: "'Poppins', sans-serif",
                ...
                children: escapeTaunt
              }
            ),
            canClickNo && /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                style: {
                  fontFamily: "'Poppins', sans-serif",
                ...
                children: "Fine fine, you can click it now... but are you SURE? 😭"
              }
            )
          ]
        }
...
function FloatingHearts() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      children: HEARTS.map((heart, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          style: {
            position: "absolute",
            ...
            animation: `heartFloat ${3 + i % 4 * 1.2}s ease-in-out ${i * 0.6}s infinite`,
            opacity: 0.7
          },
          children: heart
        },
...
function IntroPage({ onNext }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      className: "page-layer",
      style: {
        background: "radial-gradient(ellipse at 50% 60%, oklch(93% 0.03 5) 0%, oklch(97% 0.015 5) 70%)",
        position: "relative"
      },
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(FloatingHearts, {}),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            style: {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "p",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontStyle: "italic" }, children: "Something from the heart 🥺" })
                  ]
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "slide-up-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  type: "button",
                  className: "btn-romantic btn-romantic-primary btn-glow-pulse",
...
function NoPage({ onTryAgain }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      className: "page-layer",
      style: {
        background: "radial-gradient(ellipse at 50% 50%, oklch(91% 0.04 10) 0%, oklch(97% 0.015 5) 80%)"
      },
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                style: {
                  width: "100%",
                  background: "linear-gradient(135deg, white 0%, oklch(97% 0.02 5) 100%)"
                },
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "h1",
                    {
                      ...
                      children: "You're not allowed to click no, my love 😤💗"
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "p",
                    {
                      ...
                      children: "You have to forgive me…"
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "p",
                    {
                      ...
                      children: "because after all, it's just me and you 🥺💞"
                    }
                  )
                ]
              }
...
function YesPage() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      className: "page-layer",
      style: {
        background: "radial-gradient(ellipse at 50% 40%, oklch(90% 0.05 10) 0%, oklch(93% 0.03 5) 40%, oklch(97% 0.015 5) 100%)",
        position: "relative",
        minHeight: "100dvh"
      },
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CelebrationParticles, {}),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            style: {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "h1",
                {
                  ...
                  children: "I lovvvvveeeeee youuuuuueeeee meraaaa bchaaaaaaaaa 💖💖💖💖💖😘😘😘🤗🤗💞💞"
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  style: {
                    width: "100%",
                    background: "linear-gradient(135deg, white 0%, oklch(97% 0.025 5) 100%)"
                  },
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: "2rem", marginBottom: "1rem" }, children: "🥺💗" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "p",
                      {
                        style: {
                        ...
                        children: "Thank youuu veryyyyy muchhhh for forgiving me 🥺💗"
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "p",
                      {
                        ...
                        children: "Now please call me naaa… I'm missing you a lot 😭💞"
                      }
                    )
                  ]
                }
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "slide-up-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "a",
                {
                  ...
                  style: {
                    fontSize: "1.1rem",
                    padding: "1rem 2.5rem",
                    background: "linear-gradient(135deg, oklch(55% 0.19 150), oklch(60% 0.18 150))",
                    boxShadow: "0 4px 24px oklch(55% 0.19 150 / 0.4)",
                    display: "inline-flex"
                  },
                  children: "Call me maybe? 📞💖"
                }
              ) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: "With all my love, always 💗🌹"
                }
              )
            ]
          }
...
function App() {
  ...
  const [displayedPage, setDisplayedPage] = reactExports.useState("intro");
  ...
  const handleNext = reactExports.useCallback(() => navigateTo("apology"), [navigateTo]);
  const handleYes = reactExports.useCallback(() => navigateTo("yes"), [navigateTo]);
  const handleNo = reactExports.useCallback(() => navigateTo("no"), [navigateTo]);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        !prefersReducedMotion && /* @__PURE__ */ jsxRuntimeExports.jsx(PetalCanvas, {}),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              displayedPage === "intro" && /* @__PURE__ */ jsxRuntimeExports.jsx(IntroPage, { onNext: handleNext }),
              displayedPage === "apology" && /* @__PURE__ */ jsxRuntimeExports.jsx(ApologyPage, { onYes: handleYes, onNo: handleNo }),
              displayedPage === "no" && /* @__PURE__ */ jsxRuntimeExports.jsx(NoPage, { onTryAgain: handleTryAgain }),
              displayedPage === "yes" && /* @__PURE__ */ jsxRuntimeExports.jsx(YesPage, {})
            ]
          },
          displayedPage
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "footer",
          {
            ...
            children: [
              ...
              " Built with",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "oklch(60% 0.18 10)" }, children: "♥" }),
              " using",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "a",
